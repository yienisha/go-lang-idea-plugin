...
public class GoTemplateAndExprImpl extends GoTemplateExpressionImpl implements GoTemplateAndExpr {

  public GoTemplateAndExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof GoTemplateVisitor) ((GoTemplateVisitor)visitor).visitAndExpr(this);
