...
public class GoTemplateCompositeElementType extends IElementType {
  public GoTemplateCompositeElementType(String expr) {super(expr, GoTemplateLanguage.INSTANCE);}
}
